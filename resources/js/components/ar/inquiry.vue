<template>
          ...
          <div class="container">
            <div class="row">
              <div class="col-lg-12 text-center">
                <h2 class="section-heading text-uppercase">الإستعلام عن سياره مبلغ عنها</h2>
                <h3 class="section-subheading text-muted">نحن نستطيع أن <span>نساعد</span>.</h3>
              </div>
            </div>
            <div class="row" v-if="formshow">
              <div class="col-12">
                ...
                <form id="contactForm" enctype="multipart/form-data" v-if="formshow">
                  ...
                  <div class="row">
                   <div class="col-6">
                     <the-mask mask="2-###-###-###-##"  type="tel" placeholder="رقم الهاتف الشخصي" class="form-control" v-model="monumber"></the-mask>
                    
                  </div>
                 <div class="col-6">
                     <input type="text" class="form-control" placeholder="الرمز السري" maxlength="15" v-model="code">
                 </div>
                  </div>
                     <div class="text-center">
                      <button id="sendMessageButton" class="btn btn-primary btn-xl text-uppercase text-center" type="submit" @click.prevent="getinqdata">بحث</button>
                  </div>
  ...
  <td><a :href=" 'http://maps.google.com/maps?z=18&t=m&q=loc:'+datafound.address_latitude+','+datafound.address_longitude">الموقع</a></td>
