          ...
          <div class="container">
            <div class="row">
              <div class="col-lg-12 text-center">
                <h2 class="section-heading text-uppercase">INFORM .. Help US!!</h2>
           ...
           <div v-if="isLoading" class="row">
            ...
            <div class="row" v-if='spineer2'>
                ...
                <div class="row">
                        ...
                        <div class="col-sm-12 col-md-12 col-xs-12 table-responsive" v-if="founddata" style="text-align: center;">
                            ...
                            <table class="table api2" style="overflow-x:auto;">
                                            ...
                                            <tbody>
                                                ...
                                                <td><a href="#" @click="inform"> Inform </a></td>
                     ...
                     <div class="row"><div class="col-12" style="text-align:left; color:red;margin-top:10%">
     <h2>Notices:</h2>
     <p>1- we use location services.</p>
     <p>2- make sure your device location is turned on</p>
     <p>3- without location you can't inform. Help Us  </p>
     </div> 
     </div>
          </div>                
