          ...
          <div class="container">
            <div class="row">
              <div class="col-lg-12 text-center">
                <h2 class="section-heading text-uppercase">Send Your Car Information</h2>
              ...
              <div class="col-lg-12 text-center">
               ...
               <h3 class="text-uppercase" id="success" v-if = "registerd_message">Please save your refernced code: <p style="color:red">{{code}}</p></h3>
              </div>
            </div>
           <div v-if="isLoading" >
                  ...
                  <div class="row">
                   <div class="col-6">
                    ...
                    <div class="col-6">
                     ...
                     <the-mask mask="2-###-###-###-##"  type="tel" placeholder="Phone Number" class="form-control" v-model="phoneNumber"></the-mask>
                  </div>
                  </div>
                     <div class="row">
                       ...
                       <div class="col-6 " >
                         <br>
                      <label style="color:#ffff;"> Numbers </label>
...
<the-mask mask="####" type="text" id="input4"  v-if="display2" v-model="no4" style="width:53px;" minlength="3" maxlength="4" placeholder="1234" tabindex=4 />
                     ...
                     <div class="text-center">
                      <button id="sendMessageButton" class="btn btn-primary btn-xl text-uppercase text-center" type="submit" @click.prevent="submitForm">Send Message</button>
                  </div>
